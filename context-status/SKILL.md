...
**Zona 2 — Barra de contexto:** label "Contexto" + barra de progresso horizontal (height 6px, border-radius 3px, `role="progressbar"`, `aria-valuenow`, `aria-valuemin="0"`, `aria-valuemax="100"`) preenchida proporcionalmente + percentual `~N% (±8%)`. Cor da barra: `#639922` ≤40% · `#EF9F27` 41–70% · `#E24B4A` >70%.
