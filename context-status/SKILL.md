...
- **Performance:** Sempre emita HTML/SVG minificado (em uma única linha ou com mínimo de quebras de linha/espaços em branco) para economizar tokens de saída e acelerar a geração do card (Time To First Token).
