...
- **Estabilidade de Layout (Mitigação):** Instrua o modelo a limitar o comprimento de campos dinâmicos (ex: projetos, decisões, arquivos) a no máximo 60 caracteres, truncando com `...`. Como não há camada de consumo para validação determinística, isso age como uma defesa de melhor esforço contra quebras visuais e exaustão no layout.
