...
- **Segurança (Prevenção de XSS):** Sanitize/escape todas as entidades HTML (`<`, `>`, `&`, `"`, `'`) de strings de contexto inseridas pelo usuário (projetos, arquivos, decisões) antes de renderizar o card
