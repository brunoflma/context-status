...
- **Performance (Minificação):** emita o HTML do card **minificado** (em uma única linha, sem quebras ou espaços desnecessários) para otimizar o tempo de geração e reduzir o consumo de tokens de saída.
